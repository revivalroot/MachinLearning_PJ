...
style: |
  ...
  h1 { font-size: 38px; }
  h2 { font-size: 30px; color: var(--warm); border-bottom: 2px solid var(--orange); padding-bottom: 8px; margin-bottom: 24px; }
  h3 { font-size: 24px; color: var(--warm); }

  p, li { color: var(--dark); }

  strong { color: var(--orange-dark); }

  a { color: var(--orange); text-decoration: none; }

  table { font-size: 20px; margin: 0; border-collapse: collapse; }
  table th {
  ...
  /* Lead (title) slide */
  section.lead {
    background: linear-gradient(145deg, var(--dark) 0%, #2a2a28 60%, #3a3530 100%);
    color: var(--light);
    text-align: center;
    display: flex;
  ...
  section.lead table th {
    background-color: rgba(255,255,255,0.15);
    color: var(--light);
  }
  section.lead table td {
    color: var(--light);
